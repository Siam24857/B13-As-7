...
const Ferinddettails = () => {
    ...
    if (loading) {
        return <div className="text-center p-10"> Load</div>;
    }

    if (!freindetails) {
        return <div className="text-center p-10">not load</div>;
    }
            ...
            <div className='container mx-auto'>
                <div className='flex-none md:flex justify-center gap-5'>
                            ...
                            <div className='bg-white rounded-2xl shadow-xl w-[350px]'>
                                <div className='p-6 space-y-4'>
                                    <div className='flex justify-center items-center'>
                                        <Image width={100} height={100} src={picture} alt={name} className='rounded-full'></Image>
                                    </div>
                                    ...
                                    <div className='flex gap-3 justify-center items-center'>
                                        {tags.map((tag, index) => (
                                            <div className='bg-blue-300 p-2 rounded-4xl' key={index}>{tag}</div>
                                        ))}
                                    </div>
                    ...
                    <div className='space-y-10'>
                        ...
                        <div className='p-12 rounded-2xl shadow-xl bg-white flex justify-between'>
